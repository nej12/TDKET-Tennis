...
const Title = () => {
  return (
    <div>
        <div className="p-4"><h1 className="text-center font-bold text-6xl leading-snug font-poppins">Founders & History</h1></div> 
        <div className="p-8 flex justify-between space-x-4 items-center h-screen">
          <img src={founder} className="rounded-3xl w-1/3 h-full" />
